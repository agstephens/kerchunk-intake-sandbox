...
kc_paths_file=kc-paths-files.txt
cache_dir=/gws/nopw/j04/cedaproc/astephens/KERCHUNK-CACHE-FILES
...
#    ./map-paths-from-list.py $file_list_file $file_uris_file
    ...
    _cmd="kerchunk_tools create -p $prefix -o $kc_file -b $max_bytes -C $cache_dir -f $file_list_file"
